...
<div class="row">
    ...
    <div class="box box-primary" id="add_grade">
        <div class="box-header with-border">
            <h3 class="box-title text-bold">Add Section</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ url('/add-section') }}" method="post" role="form">
            {{ csrf_field() }}
            <div class="box-body" id="add_grade_form">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="section_name" class="form-control" id="section_name" placeholder="(Ex: Boys)">
                </div>
